...
export default class MovieHome extends Component {
  ...
  render() {
    //console.log(jobsrchs.length);
    const {totalSlide, currentSlide, isNext, isPrev} = this.state;
    const noOfSlides = jobsrchs.length;//Math.ceil(jobsrchs.length / cardPerSlide);
    ...
    return (
      <View style={styles.container}>
        <View style={styles.navBar}>
          <Text style={styles.navBarTitle}>Carouse Sample</Text>
        </View>
